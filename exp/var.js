...
for (let i=0; i<practiceTrial1.listA.length; i++) {
    practiceTrials.push({stimulus: practiceTrial1.listA[i], duration: durationForListWords, response_ends_trial:false, data: {test_part:"practice", stim: practiceTrial1.listA[i], drmTrial_type:"practice", word_position:"list"}, confidence: 'x'}); //creating csv file
...
for (let i=0; i<practiceTrial2.listA.length; i++) {
    practiceTrials.push({stimulus: practiceTrial2.listA[i], duration: durationForListWords, response_ends_trial:false, data: {test_part:"practice", stim: practiceTrial2.listA[i], drmTrial_type:"practice", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
//practiceTrials.push({stimulus: "TONE1", data: {test_part:"practice", stim: "tone1", drmTrial_type:"practice"}, confidence: 'x'}); // pushes 7th item
practiceTrials.push({stimulus: practiceTrial2.prototype, data: {test_part:"practice", stim: practiceTrial2.prototype, duration: durationForTargetWords, response_ends_trial:false, drmTrial_type:"practice", word_position:"target", correct_response: "74"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // pushes 8th item placeholder for prototype
//practiceTrials.push({stimulus: "TONE2", data: {test_part:"practice", stim: "tone2", drmTrial_type:"practice"}, confidence: 'x'}); // pushes 9th item placeholder for TONE2
...
for (let i=0; i<incongruentPrototypeTrial3.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial3.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial3.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type:"incongruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentPrototypeTrial4.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial4.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial4.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type:"incongruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentPrototypeTrial5.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial5.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial5.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type:"incongruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentPrototypeTrial6.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial6.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial6.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type:"incongruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentPrototypeTrial7.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial7.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial7.listA[i], drmTrial_type:"incongruentPrototype",word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type:"incongruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentPrototypeTrial8.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial8.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial8.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type:"incongruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentPrototypeTrial9.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial9.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial9.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type:"incongruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentPrototypeTrial10.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial10.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial10.listA[i], drmTrial_type:"incongruentPrototype", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type:"incongruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentPrototypeTrial11.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial11.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial11.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type:"incongruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentPrototypeTrial12.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial12.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial12.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type:"incongruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentPrototypeTrial13.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial13.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial13.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type:"incongruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentPrototypeTrial14.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial14.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial14.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type:"incongruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentPrototypeTrial15.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial15.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial15.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type:"incongruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentPrototypeTrial16.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial16.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial16.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type:"incongruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentPrototypeTrial17.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial17.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial17.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type:"incongruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentPrototypeTrial18.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial18.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial18.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type:"incongruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial2.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial2.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial2.listB[i], drmTrial_type: "congruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "congruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial3.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial3.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial3.listB[i], drmTrial_type: "congruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "congruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial4.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial4.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial4.listB[i], drmTrial_type: "congruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "congruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial5.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial5.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial5.listB[i], drmTrial_type: "congruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "congruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial6.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial6.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial6.listB[i], drmTrial_type: "congruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "congruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial7.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial7.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial7.listB[i], drmTrial_type: "congruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "congruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial8.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial8.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial8.listB[i], drmTrial_type: "congruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "congruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial9.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial9.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial9.listB[i], drmTrial_type: "congruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "congruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial10.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial10.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial10.listB[i], drmTrial_type: "congruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "congruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial11.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial11.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial11.listB[i], drmTrial_type: "congruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "congruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial12.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial12.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial12.listB[i], drmTrial_type: "congruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "congruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial13.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial13.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial13.listB[i], drmTrial_type: "congruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "congruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial14.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial14.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial14.listB[i], drmTrial_type: "congruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "congruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial15.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial15.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial15.listB[i], drmTrial_type: "congruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "congruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial16.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial16.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial16.listB[i], drmTrial_type: "congruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "congruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial17.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial17.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial17.listB[i], drmTrial_type: "congruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "congruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial18.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial18.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial18.listB[i], drmTrial_type: "congruentPrototype", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "congruentPrototype"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial2[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial2[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial2[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "incongruentHighestAssociate"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial3[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial3[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial3[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "incongruentHighestAssociate"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial4[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial4[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial4[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "incongruentHighestAssociate"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial5[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial5[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial5[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "incongruentHighestAssociate"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial6[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial6[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial6[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "incongruentHighestAssociate"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial7[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial7[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial7[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "incongruentHighestAssociate"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial8[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial8[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial8[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "incongruentHighestAssociate"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial9[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial9[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial9[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "incongruentHighestAssociate"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial10[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial10[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial10[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "incongruentHighestAssociate"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial11[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial11[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial11[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "incongruentHighestAssociate"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial12[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial12[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial12[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "incongruentHighestAssociate"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial13[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial13[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial13[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "incongruentHighestAssociate"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial14[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial14[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial14[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "incongruentHighestAssociate"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial15[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial15[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial15[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "incongruentHighestAssociate"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial16[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial16[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial16[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "incongruentHighestAssociate"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial17[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial17[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial17[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "incongruentHighestAssociate"}, confidence: 'x'}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial18[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial18[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial18[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1", drmTrial_type: "incongruentHighestAssociate"}, confidence: 'x'}); // pushes 7th item
...
//this section shows how to make  trial where the highest assocaite is in the 2nd word position 
for (let i=0; i<1; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial2.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial2.listB[i], drmTrial_type: "congruentHighestAssociate_2", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
//this section shows how to make  trial where the highest assocaite is in the 2nd word position 
for (let i=0; i<1; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial3.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial3.listB[i], drmTrial_type: "congruentHighestAssociate_2", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
//this section shows how to make  trial where the highest assocaite is in the 2nd word position 
for (let i=0; i<1; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial4.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial4.listB[i], drmTrial_type: "congruentHighestAssociate_2", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
//this section shows how to make  trial where the highest assocaite is in the 2nd word position 
for (let i=0; i<1; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial5.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial5.listB[i], drmTrial_type: "congruentHighestAssociate_2", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}

// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial5.highestAssociates[0], data: {test_part:"test", stim: congruentHighestAssociateTrial5.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_2", word_position: "target", correct_response: "74"}, confidence: 'x'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
// how to create trial for highest associate in 3rd position
for (let i=0; i<2; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial7.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial7.listB[i], drmTrial_type:"congruentHighestAssociate_3", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}

// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial7.highestAssociates[0],  data: {test_part:"test", stim: congruentHighestAssociateTrial7.highestAssociates[0], drmTrial_type:"congruentHighestAssociate_3", word_position: "target", correct_response: "74"}, confidence: 'x'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
// how to create trial for highest associate in 3rd position
for (let i=0; i<2; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial8.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial8.listB[i], drmTrial_type:"congruentHighestAssociate_3", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}

// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial8.highestAssociates[0],  data: {test_part:"test", stim: congruentHighestAssociateTrial8.highestAssociates[0], drmTrial_type:"congruentHighestAssociate_3", word_position: "target", correct_response: "74"}, confidence: 'x'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
// how to create trial for highest associate in 3rd position
for (let i=0; i<2; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial9.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial9.listB[i], drmTrial_type:"congruentHighestAssociate_3", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
// how to create trial for highest associate in 4th position
for (let i=0; i<3; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial11.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial11.listB[i], drmTrial_type: "congruentHighestAssociate_4", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}

// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial11.highestAssociates[0],  data: {test_part:"test", stim: congruentHighestAssociateTrial11.highestAssociates[0], drmTrial_type:"congruentHighestAssociate_4", word_position: "target", correct_response: "74"}, confidence: 'x'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
// how to create trial for highest associate in 4th position
for (let i=0; i<3; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial12.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial12.listB[i], drmTrial_type: "congruentHighestAssociate_4", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}

// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial12.highestAssociates[0],  data: {test_part:"test", stim: congruentHighestAssociateTrial12.highestAssociates[0], drmTrial_type:"congruentHighestAssociate_4", word_position: "target", correct_response: "74"}, confidence: 'x'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
// how to create trial for highest associate in 4th position
for (let i=0; i<3; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial13.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial13.listB[i], drmTrial_type: "congruentHighestAssociate_4", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
// how to create congruent highest associate trials with highests associate in 5th position
for (let i=0; i<4; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial15.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial15.listB[i], drmTrial_type: "congruentHighestAssociate_5", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}

// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial15.highestAssociates[0], data: {test_part:"test", stim: congruentHighestAssociateTrial15.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_5", word_position: "target", correct_response: "74"}, confidence: 'x'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
// how to create congruent highest associate trials with highests associate in 5th position
for (let i=0; i<4; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial16.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial16.listB[i], drmTrial_type: "congruentHighestAssociate_5", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}

// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial16.highestAssociates[0], data: {test_part:"test", stim: congruentHighestAssociateTrial15.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_5", word_position: "target", correct_response: "74"}, confidence: 'x'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
// how to create congruent highest associate trials with highests associate in 5th position
for (let i=0; i<4; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial17.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial17.listB[i], drmTrial_type: "congruentHighestAssociate_5", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}

// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial17.highestAssociates[0], data: {test_part:"test", stim: congruentHighestAssociateTrial17.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_5", word_position: "target", correct_response: "74"}, confidence: 'x'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
// how to create congruent highest associate trials with highests associate in 5th position
for (let i=0; i<4; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial18.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial18.listB[i], drmTrial_type: "congruentHighestAssociate_5", word_position: "list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}

// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial18.highestAssociates[0], data: {test_part:"test", stim: congruentHighestAssociateTrial18.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_5", word_position: "target", correct_response: "74"}, confidence: 'x'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
