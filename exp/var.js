...
for (let i=0; i<incongruentPrototypeTrial3.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial3.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial3.listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial16.prototype}); // pushes 8th item placeholder for prototype
incongruentPrototypeTrials.push({stimulus: "TONE2"}); // pushes 9th item placeholder for TONE2

// pushes 6 items from listA
for (let i=0; i<incongruentPrototypeTrial4.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial4.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial4.listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial15.prototype}); // pushes 8th item placeholder for prototype
incongruentPrototypeTrials.push({stimulus: "TONE2"}); // pushes 9th item placeholder for TONE2

// pushes 6 items from listA
for (let i=0; i<incongruentPrototypeTrial5.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial5.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial5.listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial14.prototype}); // pushes 8th item placeholder for prototype
incongruentPrototypeTrials.push({stimulus: "TONE2"}); // pushes 9th item placeholder for TONE2

// pushes 6 items from listA
for (let i=0; i<incongruentPrototypeTrial6.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial6.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial6.listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial13.prototype}); // pushes 8th item placeholder for prototype
incongruentPrototypeTrials.push({stimulus: "TONE2"}); // pushes 9th item placeholder for TONE2

// pushes 6 items from listA
for (let i=0; i<incongruentPrototypeTrial7.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial7.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial7.listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial12.prototype}); // pushes 8th item placeholder for prototype
incongruentPrototypeTrials.push({stimulus: "TONE2"}); // pushes 9th item placeholder for TONE2

// pushes 6 items from listA
for (let i=0; i<incongruentPrototypeTrial8.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial8.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial8.listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial11.prototype}); // pushes 8th item placeholder for prototype
incongruentPrototypeTrials.push({stimulus: "TONE2"}); // pushes 9th item placeholder for TONE2

// pushes 6 items from listA
for (let i=0; i<incongruentPrototypeTrial9.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial9.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial9.listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial10.prototype}); // pushes 8th item placeholder for prototype
incongruentPrototypeTrials.push({stimulus: "TONE2"}); // pushes 9th item placeholder for TONE2

// pushes 6 items from listA
for (let i=0; i<incongruentPrototypeTrial10.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial10.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial10.listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial9.prototype}); // pushes 8th item placeholder for prototype
incongruentPrototypeTrials.push({stimulus: "TONE2"}); // pushes 9th item placeholder for TONE2

// pushes 6 items from listA
for (let i=0; i<incongruentPrototypeTrial11.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial11.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial11.listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial8.prototype}); // pushes 8th item placeholder for prototype
incongruentPrototypeTrials.push({stimulus: "TONE2"}); // pushes 9th item placeholder for TONE2

// pushes 6 items from listA
for (let i=0; i<incongruentPrototypeTrial12.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial12.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial12.listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial7.prototype}); // pushes 8th item placeholder for prototype
incongruentPrototypeTrials.push({stimulus: "TONE2"}); // pushes 9th item placeholder for TONE2

// pushes 6 items from listA
for (let i=0; i<incongruentPrototypeTrial13.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial13.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial13.listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial6.prototype}); // pushes 8th item placeholder for prototype
incongruentPrototypeTrials.push({stimulus: "TONE2"}); // pushes 9th item placeholder for TONE2

// pushes 6 items from listA
for (let i=0; i<incongruentPrototypeTrial14.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial14.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial14.listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial5.prototype}); // pushes 8th item placeholder for prototype
incongruentPrototypeTrials.push({stimulus: "TONE2"}); // pushes 9th item placeholder for TONE2

// pushes 6 items from listA
for (let i=0; i<incongruentPrototypeTrial15.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial15.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial15.listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial4.prototype}); // pushes 8th item placeholder for prototype
incongruentPrototypeTrials.push({stimulus: "TONE2"}); // pushes 9th item placeholder for TONE2

// pushes 6 items from listA
for (let i=0; i<incongruentPrototypeTrial16.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial16.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial16.listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial3.prototype}); // pushes 8th item placeholder for prototype
incongruentPrototypeTrials.push({stimulus: "TONE2"}); // pushes 9th item placeholder for TONE2

// pushes 6 items from listA
for (let i=0; i<incongruentPrototypeTrial17.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial17.listA[i], data: {test_part:"test", stim: incongruentPrototypeTrial17.listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial3.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial3.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial3.listB[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial4.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial4.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial4.listB[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial5.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial5.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial5.listB[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial6.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial6.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial6.listB[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial7.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial7.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial7.listB[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial8.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial8.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial8.listB[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial9.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial9.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial9.listB[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial10.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial10.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial10.listB[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial11.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial11.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial11.listB[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial12.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial12.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial12.listB[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial13.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial13.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial13.listB[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial14.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial14.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial14.listB[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial15.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial15.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial15.listB[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial16.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial16.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial16.listB[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
...
for (let i=0; i<congruentPrototypeTrial17.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial17.listB[i], data: {test_part:"test", stim: congruentPrototypeTrial17.listB[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
congruentPrototypeTrials.push({stimulus: "TONE1"}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial4[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial4[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial4[0].listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1"}}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial5[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial5[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial5[0].listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1"}}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial6[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial6[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial6[0].listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1"}}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial7[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial7[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial7[0].listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1"}}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial8[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial8[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial8[0].listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1"}}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial9[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial9[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial9[0].listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1"}}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial10[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial10[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial10[0].listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1"}}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial11[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial11[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial11[0].listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1"}}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial12[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial12[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial12[0].listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1"}}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial13[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial13[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial13[0].listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1"}}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial14[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial14[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial14[0].listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1"}}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial15[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial15[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial15[0].listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1"}}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial16[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial16[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial16[0].listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1"}}); // pushes 7th item
...
for (let i=0; i<incongruentHighestAssociateTrial17[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial17[0].listA[i], data: {test_part:"test", stim: incongruentHighestAssociateTrial17[0].listA[i]}}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: "TONE1", data: {test_part:"test", stim: "tone1"}}); // pushes 7th item
