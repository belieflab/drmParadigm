//this version of var audio cahnges the structure of the incongruent highest associate trials. In this version, the incongruent highgst associate trials include the incongruent highest assocaite in the list of words presented. 
"use strict";
...
for (let i = 0; i < 1; i++) {
    incongruentHighestAssociateTrials.push({
        ...
        data: {
            ...
            condition: "incongruentHighestAssociate_2",
            word_position: "list",
        },
        confidence: "x",
    });
...
for (let i = 2; i < incongruentHighestAssociateTrial1[0].listA[i]; i++) {
    incongruentHighestAssociateTrials.push({
        stimulus: incongruentHighestAssociateTrial1[0].listA[i],
        trial_duration: durationForListWords,
        response_ends_trial: false,
