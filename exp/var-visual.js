...
for (let i=0; i<practiceTrial1.listA.length; i++) {
    practiceTrials.push({prompt:"", stimulus: practiceTrial1.listA[i], prompt_end:"", duration: durationForListWords, response_ends_trial:false, data: {test_part:"practice", stim: practiceTrial1.listA[i], drmTrial_type:"practice", word_position:"list"}, confidence: 'x'}); //creating csv file
...
for (let i=0; i<practiceTrial2.listA.length; i++) {
    practiceTrials.push({prompt: "", stimulus: practiceTrial2.listA[i], prompt_end: "", duration: durationForListWords, response_ends_trial:false, data: {test_part:"practice", stim: practiceTrial2.listA[i], drmTrial_type:"practice", word_position:"list"}, confidence: 'x'}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
//practiceTrials.push({stimulus: "TONE1", data: {test_part:"practice", stim: "tone1", drmTrial_type:"practice"}, confidence: 'x'}); // pushes 7th item
