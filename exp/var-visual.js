...
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial1[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial3[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial1's 2nd list)
...
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial2[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial2[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial2's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial3[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial3[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial4[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial4[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial5[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial5[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial6[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial6[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial7[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial7[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial8[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial8[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial10[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial10[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial11[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial11[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial12[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial12[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial13[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial13[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial14[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial14[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial15[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial15[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial17[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial17[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial18[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial18[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial1.highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial1.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_2", word_position: "target", correct_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial2.highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial2.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_2", word_position: "target", correct_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
congruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "congruentHighestAssociate_2"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial3.highestAssociates[0], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial3.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_2", word_position: "list"}, confidence: ''});
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial3.highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial3.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_2", word_position: "target", correct_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
congruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "congruentHighestAssociate_2"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial4.highestAssociates[0], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial4.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_2", word_position: "list"}, confidence: ''});
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial4.highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial4.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_2", word_position: "target", correct_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
congruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "congruentHighestAssociate_2"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial5.highestAssociates[0], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial5.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_2", word_position: "list"}, confidence: ''}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial5.highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial5.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_2", word_position: "target", correct_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
congruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "congruentHighestAssociate_2"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial6.highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial6.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_3", word_position: "target", correct_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial7.highestAssociates[0],duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial7.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_3", word_position: "target", correct_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
congruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "congruentHighestAssociate_3"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial8.highestAssociates[0], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial8.highestAssociates[0], drmTrial_type:"congruentHighestAssociate_3", word_position: "list"}, confidence: ''}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial8.highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial8.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_3", word_position: "target", correct_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
congruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "congruentHighestAssociate_3"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial9.highestAssociates[0], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial9.highestAssociates[0], drmTrial_type:"congruentHighestAssociate_3", word_position: "list"}, confidence: ''}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial10.highestAssociates[0], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial10.highestAssociates[0], drmTrial_type:"congruentHighestAssociate_4", word_position:"list"}, confidence: ''}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial10.highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial10.highestAssociates[0], drmTrial_type:"congruentHighestAssociate_4", word_position: "target", correct_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial11.highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial11.highestAssociates[0], drmTrial_type:"congruentHighestAssociate_4", word_position: "target", correct_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
congruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "congruentHighestAssociate_4"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial12.highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial12.highestAssociates[0], drmTrial_type:"congruentHighestAssociate_4", word_position: "target", correct_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
congruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "congruentHighestAssociate_4"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial13.highestAssociates[0], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial13.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_4", word_position: "list"}, confidence: ''}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial14.highestAssociates[0], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial14.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_5", word_position:"list"}, confidence: ''}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial14.highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial14.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_5", word_position: "target", correct_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial15.highestAssociates[0], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial15.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_5", word_position: "list"}, confidence: ''}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial15.highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial15.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_5", word_position: "target", correct_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
congruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "congruentHighestAssociate_5"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial16.highestAssociates[0], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial15.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_5", word_position: "list"}, confidence: ''}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial16.highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial16.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_5", word_position: "target", correct_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
congruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "congruentHighestAssociate_5"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial17.highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial17.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_5", word_position: "target", correct_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
congruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "congruentHighestAssociate_5"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial18.highestAssociates[0], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial18.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_5", word_position: "list"}, confidence: ''}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial18.highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial18.highestAssociates[0], drmTrial_type: "congruentHighestAssociate_5", word_position: "target", correct_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
congruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "congruentHighestAssociate_5"}, confidence: ''}); // pushes 9th item placeholder for TONE2
