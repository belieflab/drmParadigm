...
//this section shows how to make  trial where the highest assocaite is in the 2nd word position 
for (let i=0; i<1; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial2.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial2.listB[i], drmTrial_type: "congruentHighestAssociate_2", word_position: "list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
//this section shows how to make  trial where the highest assocaite is in the 2nd word position 
for (let i=0; i<1; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial3.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial3.listB[i], drmTrial_type: "congruentHighestAssociate_2", word_position: "list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
//this section shows how to make  trial where the highest assocaite is in the 2nd word position 
for (let i=0; i<1; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial4.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial4.listB[i], drmTrial_type: "congruentHighestAssociate_2", word_position: "list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
//this section shows how to make  trial where the highest assocaite is in the 2nd word position 
for (let i=0; i<1; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial5.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial5.listB[i], drmTrial_type: "congruentHighestAssociate_2", word_position: "list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
// how to create trial for highest associate in 3rd position
for (let i=0; i<2; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial7.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial7.listB[i], drmTrial_type:"congruentHighestAssociate_3", word_position: "list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
// how to create trial for highest associate in 3rd position
for (let i=0; i<2; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial8.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial8.listB[i], drmTrial_type:"congruentHighestAssociate_3", word_position: "list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
// how to create trial for highest associate in 3rd position
for (let i=0; i<2; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial9.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial9.listB[i], drmTrial_type:"congruentHighestAssociate_3", word_position: "list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
// how to create trial for highest associate in 4th position
for (let i=0; i<3; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial11.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial11.listB[i], drmTrial_type: "congruentHighestAssociate_4", word_position: "list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
// how to create trial for highest associate in 4th position
for (let i=0; i<3; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial12.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial12.listB[i], drmTrial_type: "congruentHighestAssociate_4", word_position: "list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
// how to create trial for highest associate in 4th position
for (let i=0; i<3; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial13.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial13.listB[i], drmTrial_type: "congruentHighestAssociate_4", word_position: "list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
// how to create congruent highest associate trials with highests associate in 5th position
for (let i=0; i<4; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial15.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial15.listB[i], drmTrial_type: "congruentHighestAssociate_5", word_position: "list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
// how to create congruent highest associate trials with highests associate in 5th position
for (let i=0; i<4; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial16.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial16.listB[i], drmTrial_type: "congruentHighestAssociate_5", word_position: "list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
// how to create congruent highest associate trials with highests associate in 5th position
for (let i=0; i<4; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial17.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial17.listB[i], drmTrial_type: "congruentHighestAssociate_5", word_position: "list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
// how to create congruent highest associate trials with highests associate in 5th position
for (let i=0; i<4; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial18.listB[i], data: {test_part:"test", stim: congruentHighestAssociateTrial18.listB[i], drmTrial_type: "congruentHighestAssociate_5", word_position: "list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
