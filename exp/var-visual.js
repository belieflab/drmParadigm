...
practiceTrials.push({prompt: "Did you see the word?", stimulus: practiceTrial2.prototype, prompt_end:"", duration: durationForTargetWords, data: {test_part:"practice", stim: practiceTrial2.prototype, response_ends_trial:false, drmTrial_type:"practice", word_position:"target", correct_response: "106", incorrect_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // pushes 8th item placeholder for prototype
practiceTrials.push({prompt:"",stimulus: "", prompt_end: "", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"practice", stim: "fixation", drmTrial_type:"practice"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
for (let i=0; i<incongruentPrototypeTrial1.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial1.listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentPrototypeTrial1.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
for (let i=0; i<incongruentPrototypeTrial2.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial2.listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", word_position: "list", data: {test_part:"test", stim: incongruentPrototypeTrial2.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
for (let i=0; i<incongruentPrototypeTrial3.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial3.listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentPrototypeTrial3.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
for (let i=0; i<incongruentPrototypeTrial4.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial4.listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentPrototypeTrial4.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
for (let i=0; i<incongruentPrototypeTrial5.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial5.listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentPrototypeTrial5.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
for (let i=0; i<incongruentPrototypeTrial6.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial6.listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentPrototypeTrial6.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
for (let i=0; i<incongruentPrototypeTrial7.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial7.listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentPrototypeTrial7.listA[i], drmTrial_type:"incongruentPrototype",word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
for (let i=0; i<incongruentPrototypeTrial8.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial8.listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentPrototypeTrial8.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
for (let i=0; i<incongruentPrototypeTrial9.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial9.listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentPrototypeTrial9.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
for (let i=0; i<incongruentPrototypeTrial10.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial10.listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentPrototypeTrial10.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
for (let i=0; i<incongruentPrototypeTrial11.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial11.listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentPrototypeTrial11.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
for (let i=0; i<incongruentPrototypeTrial12.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial12.listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentPrototypeTrial12.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
for (let i=0; i<incongruentPrototypeTrial13.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial13.listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentPrototypeTrial13.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
for (let i=0; i<incongruentPrototypeTrial14.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial14.listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentPrototypeTrial14.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
for (let i=0; i<incongruentPrototypeTrial15.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial15.listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentPrototypeTrial15.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
for (let i=0; i<incongruentPrototypeTrial16.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial16.listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentPrototypeTrial16.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
for (let i=0; i<incongruentPrototypeTrial17.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial17.listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentPrototypeTrial17.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
for (let i=0; i<incongruentPrototypeTrial18.listA.length; i++) {
    incongruentPrototypeTrials.push({stimulus: incongruentPrototypeTrial18.listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentPrototypeTrial18.listA[i], drmTrial_type:"incongruentPrototype", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
for (let i=0; i<congruentPrototypeTrial1.listB.length; i++) {
    congruentPrototypeTrials.push({stimulus: congruentPrototypeTrial1.listB[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentPrototypeTrial1.listB[i], drmTrial_type: "congruentPrototype", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
for (let i=0; i<incongruentHighestAssociateTrial1[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial1[0].listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentHighestAssociateTrial1[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial1[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial3[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102", incorrect_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial1's 2nd list)
...
for (let i=0; i<incongruentHighestAssociateTrial2[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial2[0].listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentHighestAssociateTrial2[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial2[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial2[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102", incorrect_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial2's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
for (let i=0; i<incongruentHighestAssociateTrial3[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial3[0].listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentHighestAssociateTrial3[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial3[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial3[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102", incorrect_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2


// pushes 6 items from 0th listA (which is the list A of the 0th item in the incongruentHighestAssociateTrial3 array)
for (let i=0; i<incongruentHighestAssociateTrial4[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial4[0].listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentHighestAssociateTrial4[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial4[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial4[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102", incorrect_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2

// pushes 6 items from 0th listA (which is the list A of the 0th item in the incongruentHighestAssociateTrial3 array)
for (let i=0; i<incongruentHighestAssociateTrial5[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial5[0].listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentHighestAssociateTrial5[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial5[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial5[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102", incorrect_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2


// pushes 6 items from 0th listA (which is the list A of the 0th item in the incongruentHighestAssociateTrial3 array)
for (let i=0; i<incongruentHighestAssociateTrial6[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial6[0].listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentHighestAssociateTrial6[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial6[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial6[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102", incorrect_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2

// pushes 6 items from 0th listA (which is the list A of the 0th item in the incongruentHighestAssociateTrial3 array)
for (let i=0; i<incongruentHighestAssociateTrial7[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial7[0].listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentHighestAssociateTrial7[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial7[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial7[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102", incorrect_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2

// pushes 6 items from 0th listA (which is the list A of the 0th item in the incongruentHighestAssociateTrial3 array)
for (let i=0; i<incongruentHighestAssociateTrial8[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial8[0].listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentHighestAssociateTrial8[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial8[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial8[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102", incorrect_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2

// pushes 6 items from 0th listA (which is the list A of the 0th item in the incongruentHighestAssociateTrial3 array)
for (let i=0; i<incongruentHighestAssociateTrial9[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial9[0].listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentHighestAssociateTrial9[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
for (let i=0; i<incongruentHighestAssociateTrial10[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial10[0].listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentHighestAssociateTrial10[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial10[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial10[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102", incorrect_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2


// pushes 6 items from 0th listA (which is the list A of the 0th item in the incongruentHighestAssociateTrial3 array)
for (let i=0; i<incongruentHighestAssociateTrial11[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial11[0].listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentHighestAssociateTrial11[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial11[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial11[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102", incorrect_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2

// pushes 6 items from 0th listA (which is the list A of the 0th item in the incongruentHighestAssociateTrial3 array)
for (let i=0; i<incongruentHighestAssociateTrial12[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial12[0].listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentHighestAssociateTrial12[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial12[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial12[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102", incorrect_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2

// pushes 6 items from 0th listA (which is the list A of the 0th item in the incongruentHighestAssociateTrial3 array)
for (let i=0; i<incongruentHighestAssociateTrial13[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial13[0].listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentHighestAssociateTrial13[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial13[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial13[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102", incorrect_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2

// pushes 6 items from 0th listA (which is the list A of the 0th item in the incongruentHighestAssociateTrial3 array)
for (let i=0; i<incongruentHighestAssociateTrial14[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial14[0].listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentHighestAssociateTrial14[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial14[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial14[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102", incorrect_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2

// pushes 6 items from 0th listA (which is the list A of the 0th item in the incongruentHighestAssociateTrial3 array)
for (let i=0; i<incongruentHighestAssociateTrial15[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial15[0].listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentHighestAssociateTrial15[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial15[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial15[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102", incorrect_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2

// pushes 6 items from 0th listA (which is the list A of the 0th item in the incongruentHighestAssociateTrial3 array)
for (let i=0; i<incongruentHighestAssociateTrial16[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial16[0].listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentHighestAssociateTrial16[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
for (let i=0; i<incongruentHighestAssociateTrial17[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial17[0].listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentHighestAssociateTrial17[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial17[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial17[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102", incorrect_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2

// pushes 6 items from 0th listA (which is the list A of the 0th item in the incongruentHighestAssociateTrial3 array)
for (let i=0; i<incongruentHighestAssociateTrial18[0].listA.length; i++) {
    incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial18[0].listA[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: incongruentHighestAssociateTrial18[0].listA[i], drmTrial_type: "incongruentHighestAssociate", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
incongruentHighestAssociateTrials.push({stimulus: incongruentHighestAssociateTrial18[1].highestAssociates[0], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim:incongruentHighestAssociateTrial18[1].highestAssociates[0], drmTrial_type: "incongruentHighestAssociate", word_position: "target", correct_response: "102", incorrect_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // grabs the highest assocaite from 1st item (so, in reality, it's the highest associate from incongruentHighestAssociateTrial3's 2nd list)
incongruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "incongruentHighestAssociate"}, confidence: ''}); // pushes 9th item placeholder for TONE2
...
for (let i=0; i<1; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial1.listB[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial1.listB[i], drmTrial_type: "congruentHighestAssociate_2", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
//this section shows how to make  trial where the highest assocaite is in the 2nd word position 
for (let i=0; i<1; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial2.listB[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial2.listB[i], drmTrial_type: "congruentHighestAssociate_2", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}

// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial2.highestAssociates[1], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial2.highestAssociates[1], drmTrial_type: "congruentHighestAssociate_2", word_position: "list"}, confidence: '' }); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial2.highestAssociates[1], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial2.highestAssociates[1], drmTrial_type: "congruentHighestAssociate_2", word_position: "target", correct_response: "106", incorrect_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
congruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "congruentHighestAssociate_2"}, confidence: ''}); // pushes 9th item placeholder for TONE2


//this section shows how to make  trial where the highest assocaite is in the 2nd word position 
for (let i=0; i<1; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial3.listB[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial3.listB[i], drmTrial_type: "congruentHighestAssociate_2", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}

// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial3.highestAssociates[1], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial3.highestAssociates[1], drmTrial_type: "congruentHighestAssociate_2", word_position: "list"}, confidence: ''});
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial3.highestAssociates[1], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial3.highestAssociates[1], drmTrial_type: "congruentHighestAssociate_2", word_position: "target", correct_response: "106", incorrect_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
congruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "congruentHighestAssociate_2"}, confidence: ''}); // pushes 9th item placeholder for TONE2


//this section shows how to make  trial where the highest assocaite is in the 2nd word position 
for (let i=0; i<1; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial4.listB[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial4.listB[i], drmTrial_type: "congruentHighestAssociate_2", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}

// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial4.highestAssociates[1], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial4.highestAssociates[1], drmTrial_type: "congruentHighestAssociate_2", word_position: "list"}, confidence: ''});
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial4.highestAssociates[1], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial4.highestAssociates[1], drmTrial_type: "congruentHighestAssociate_2", word_position: "target", correct_response: "106", incorrect_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
congruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "congruentHighestAssociate_2"}, confidence: ''}); // pushes 9th item placeholder for TONE2


//this section shows how to make  trial where the highest assocaite is in the 2nd word position 
for (let i=0; i<1; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial5.listB[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial5.listB[i], drmTrial_type: "congruentHighestAssociate_2", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}

// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial5.highestAssociates[1], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial5.highestAssociates[1], drmTrial_type: "congruentHighestAssociate_2", word_position: "list"}, confidence: ''}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial5.highestAssociates[1], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial5.highestAssociates[1], drmTrial_type: "congruentHighestAssociate_2", word_position: "target", correct_response: "106", incorrect_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
congruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "congruentHighestAssociate_2"}, confidence: ''}); // pushes 9th item placeholder for TONE2


// how to create trial for highest associate in 3rd position
for (let i=0; i<2; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial6.listB[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial6.listB[i], drmTrial_type:"congruentHighestAssociate_3", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}

// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial6.highestAssociates[1],duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial6.highestAssociates[1], drmTrial_type:"congruentHighestAssociate_3", word_position:"list"}, confidence: ''}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial6.highestAssociates[1], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial6.highestAssociates[1], drmTrial_type: "congruentHighestAssociate_3", word_position: "target", correct_response: "106", incorrect_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
// how to create trial for highest associate in 3rd position
for (let i=0; i<2; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial7.listB[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial7.listB[i], drmTrial_type:"congruentHighestAssociate_3", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}

// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial7.highestAssociates[1], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial7.highestAssociates[1], drmTrial_type:"congruentHighestAssociate_3", word_position: "list"}, confidence: ''}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial7.highestAssociates[1],duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial7.highestAssociates[1], drmTrial_type: "congruentHighestAssociate_3", word_position: "target", correct_response: "106", incorrect_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
congruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "congruentHighestAssociate_3"}, confidence: ''}); // pushes 9th item placeholder for TONE2


// how to create trial for highest associate in 3rd position
for (let i=0; i<2; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial8.listB[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial8.listB[i], drmTrial_type:"congruentHighestAssociate_3", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}

// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial8.highestAssociates[1], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial8.highestAssociates[1], drmTrial_type:"congruentHighestAssociate_3", word_position: "list"}, confidence: ''}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial8.highestAssociates[1], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial8.highestAssociates[1], drmTrial_type: "congruentHighestAssociate_3", word_position: "target", correct_response: "106", incorrect_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
congruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "congruentHighestAssociate_3"}, confidence: ''}); // pushes 9th item placeholder for TONE2


// how to create trial for highest associate in 3rd position
for (let i=0; i<2; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial9.listB[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial9.listB[i], drmTrial_type:"congruentHighestAssociate_3", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
for (let i=0; i<3; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial10.listB[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial10.listB[i], drmTrial_type: "congruentHighestAssociate_4", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}

// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial10.highestAssociates[1], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial10.highestAssociates[1], drmTrial_type:"congruentHighestAssociate_4", word_position:"list"}, confidence: ''}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial10.highestAssociates[1], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial10.highestAssociates[1], drmTrial_type:"congruentHighestAssociate_4", word_position: "target", correct_response: "106", incorrect_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
// how to create trial for highest associate in 4th position
for (let i=0; i<3; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial11.listB[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial11.listB[i], drmTrial_type: "congruentHighestAssociate_4", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}

// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial11.highestAssociates[1], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial11.highestAssociates[1], drmTrial_type:"congruentHighestAssociate_4", word_position: "list"}, confidence: ''}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial11.highestAssociates[1], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial11.highestAssociates[1], drmTrial_type:"congruentHighestAssociate_4", word_position: "target", correct_response: "106", incorrect_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
congruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "congruentHighestAssociate_4"}, confidence: ''}); // pushes 9th item placeholder for TONE2

// how to create trial for highest associate in 4th position
for (let i=0; i<3; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial12.listB[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial12.listB[i], drmTrial_type: "congruentHighestAssociate_4", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}

// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial12.highestAssociates[1], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial12.highestAssociates[1], drmTrial_type:"congruentHighestAssociate_4", word_position: "list"}, confidence: ''}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial12.highestAssociates[1], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial12.highestAssociates[1], drmTrial_type:"congruentHighestAssociate_4", word_position: "target", correct_response: "106", incorrect_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
congruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "congruentHighestAssociate_4"}, confidence: ''}); // pushes 9th item placeholder for TONE2

// how to create trial for highest associate in 4th position
for (let i=0; i<3; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial13.listB[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial13.listB[i], drmTrial_type: "congruentHighestAssociate_4", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}
...
for (let i=0; i<4; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial14.listB[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial14.listB[i], drmTrial_type: "congruentHighestAssociate_5", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}

// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial14.highestAssociates[1], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial14.highestAssociates[1], drmTrial_type: "congruentHighestAssociate_5", word_position:"list"}, confidence: ''}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial14.highestAssociates[1], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial14.highestAssociates[1], drmTrial_type: "congruentHighestAssociate_5", word_position: "target", correct_response: "106", incorrect_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
// how to create congruent highest associate trials with highests associate in 5th position
for (let i=0; i<4; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial15.listB[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial15.listB[i], drmTrial_type: "congruentHighestAssociate_5", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}

// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial15.highestAssociates[1], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial15.highestAssociates[1], drmTrial_type: "congruentHighestAssociate_5", word_position: "list"}, confidence: ''}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial15.highestAssociates[1], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial15.highestAssociates[1], drmTrial_type: "congruentHighestAssociate_5", word_position: "target", correct_response: "106", incorrect_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
congruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "congruentHighestAssociate_5"}, confidence: ''}); // pushes 9th item placeholder for TONE2

// how to create congruent highest associate trials with highests associate in 5th position
for (let i=0; i<4; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial16.listB[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial16.listB[i], drmTrial_type: "congruentHighestAssociate_5", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}

// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial16.highestAssociates[1], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial15.highestAssociates[1], drmTrial_type: "congruentHighestAssociate_5", word_position: "list"}, confidence: ''}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial16.highestAssociates[1], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial16.highestAssociates[1], drmTrial_type: "congruentHighestAssociate_5", word_position: "target", correct_response: "106", incorrect_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
congruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "congruentHighestAssociate_5"}, confidence: ''}); // pushes 9th item placeholder for TONE2

// how to create congruent highest associate trials with highests associate in 5th position
for (let i=0; i<4; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial17.listB[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial17.listB[i], drmTrial_type: "congruentHighestAssociate_5", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}

// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial17.highestAssociates[1], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial17.highestAssociates[1], drmTrial_type: "congruentHighestAssociate_5", word_position: "list"}, confidence: ''}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial17.highestAssociates[1], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial17.highestAssociates[1], drmTrial_type: "congruentHighestAssociate_5", word_position: "target", correct_response: "106", incorrect_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
congruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "congruentHighestAssociate_5"}, confidence: ''}); // pushes 9th item placeholder for TONE2

// how to create congruent highest associate trials with highests associate in 5th position
for (let i=0; i<4; i++) {
    congruentHighestAssociateTrials.push({stimulus:congruentHighestAssociateTrial18.listB[i], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial18.listB[i], drmTrial_type: "congruentHighestAssociate_5", word_position:"list"}, confidence: ''}); //creating csv file
    //use underscores for data fields and headers and camel case for script
}

// push the highest associate into the list 
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial18.highestAssociates[1], duration: durationForListWords, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: congruentHighestAssociateTrial18.highestAssociates[1], drmTrial_type: "congruentHighestAssociate_5", word_position: "list"}, confidence: ''}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
...
congruentHighestAssociateTrials.push({stimulus: congruentHighestAssociateTrial18.highestAssociates[1], duration: durationForTargetWords, prompt: "Did you see the word?", prompt_end:" ", data: {test_part:"test", stim: congruentHighestAssociateTrial18.highestAssociates[1], drmTrial_type: "congruentHighestAssociate_5", word_position: "target", correct_response: "106", incorrect_response: "102"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // need to check with Phil to see if there is a preference for using highest associate 0 or 1 since we are using the b lists. 
congruentHighestAssociateTrials.push({stimulus: "+", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"test", stim: "fixation", drmTrial_type: "congruentHighestAssociate_5"}, confidence: ''}); // pushes 9th item placeholder for TONE2
