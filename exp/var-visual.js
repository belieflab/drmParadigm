...
//practiceTrials.push({stimulus: "TONE1", data: {test_part:"practice", stim: "tone1", drmTrial_type:"practice"}, confidence: ''}); // pushes 7th item
practiceTrials.push({prompt: "Did you see the word?", stimulus: practiceTrial2.prototype, prompt_end:"?", duration: durationForTargetWords, data: {test_part:"practice", stim: practiceTrial2.prototype, response_ends_trial:false, drmTrial_type:"practice", word_position:"target", correct_response: "106"}, confidence: progressBar + fillUp + feedbackGenerator + timeRemaining + responseKeySelectionFigure + '<input autocomplete="autocomplete_off_hack_xfr4!k" id="tapTap" type="text" style="background-color:black; color: transparent; outline:none; border:none; background:none" onkeypress="">'}); // pushes 8th item placeholder for prototype
practiceTrials.push({prompt:"",stimulus: "+", prompt_end: "", duration: fixationDuration, prompt: " ", prompt_end: " ", data: {test_part:"practice", stim: "fixation", drmTrial_type:"practice"}, confidence: ''}); // pushes 9th item placeholder for TONE2
