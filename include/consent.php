...
<div class="loading centeredDiv">
  ...
  <div style="color:black" id="consentForm" class="consent consent-box"> 
    ...
    <p style="color:black" id="consentInstructions" class="consent">
      ...
      <br>
      You will receive the reward specified on the Mechanical-Turk HIT for completing both the game and the questionnaire. Payment for completion of the HIT is $5.00, with an additional $2.00 bonus based on task performance. Upon finishing the game and submitting the questionnaire, you will receive code numbers. Please record these two code numbers and submit them for payment. 
      <br><br>
